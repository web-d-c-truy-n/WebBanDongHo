...
<body class="g-sidenav-show g-sidenav-hidden">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ URL::to('admin/backup') }}">
                                    ...
                                    <span class="nav-link-text">Sao lưu</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#!" id="PhucHoi">
                                    <i class="fas fa-history"></i>
                                    <span class="nav-link-text">Phục hồi</span>
                                </a>
                            </li>
                        </ul>
                    </div>
    ...
    <form action="{{URL::to("admin/restore")}}" method="POST" id="from_backup" enctype="multipart/form-data" hidden>
        @csrf
        <input type="file" name="backup" onchange="if(confirm('Bạn có chắc chắn phục hồi dữ liệu này không?')){this.parentNode.submit()}"/>
    </form>	
    <script>
